                            ...
                            return (
                                <tr key={run.id} className="hover:bg-muted/50 transition-colors">
                                    <td className="px-6 py-4 font-medium">
                                        ...
                                        {run.repo && <div className="text-xs text-muted-foreground">{run.repo}</div>}
                                    </td>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <Link href={run.url || "/logs"} target={run.url ? "_blank" : undefined} className="inline-flex items-center justify-center rounded-md text-xs font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-8 px-3">
                                            Logs
                                        </Link>
                                    </td>
                                </tr>
